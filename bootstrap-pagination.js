...
var BootstrapPagination = /** @class */ (function () {
    ...
    function BootstrapPagination(obj, option) {
        ...
        if (typeof (option === null || option === void 0 ? void 0 : option.onPageChanged) !== "undefined") { //优先通过代码指定事件处理逻辑。
            ...
            //            else if (attrPageChanged.trim().substring(0, 8) == "function") {
            ...
            //#endregion
                ...
                this.onPageChanged = new Function('sender', attrPageChanged); // 动态创建函数，格式类似于 function (pageIndex: GLint, pageSize: GLint) {......}
            }
        }
        //#endregion
...
(function (BootstrapPagination) {
    ...
    BootstrapPagination.isMobile = isMobile;
    (function (isMobile) {
        isMobile._isMobile = null; //用于缓冲结果，避免冗余计算过程。
    })(isMobile = BootstrapPagination.isMobile || (BootstrapPagination.isMobile = {}));
    //#endregion
